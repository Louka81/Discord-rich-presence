...
class RPCClient extends EventEmitter {
  ...
  setActivity(args = {}, pid = getPid()) {
    ...
    let temp = {};
    if (args.largeImageKey) {
      if (args.largeImageText != null) {
        temp.large_text = args.largeImageText;
      }
      temp.large_image = args.largeImageKey;
    }
    if (args.smallImageKey) {
      if (args.smallImageText != null) {
        temp.small_text = args.smallImageText;
      }
      temp.small_image = args.smallImageKey;
    }
    assets = temp;
